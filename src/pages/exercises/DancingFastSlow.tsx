...
const DancingFastSlow = () => {
  ...
  return <div className="min-h-screen bg-gradient-to-b from-deep-teal via-sage-green to-sandy-beige">
      {/* Navigation */}
      ...
      <div className="max-w-4xl mx-auto px-4 pb-8">
        ...
        <div className="mb-16">
          ...
          <div className="bg-warm-brown/20 backdrop-blur-sm rounded-2xl p-6 mb-8 border border-cream/20">
            <div className="flex items-center justify-between mb-4">
              ...
              <Button onClick={() => playAudio('disarli-16', 'https://res.cloudinary.com/dl9xg597r/video/upload/v1749836334/SimpleMercato2-16Sec-CarlosDiSarli-La_vida_me_enga%C3%B1o_oxc9vb.mp3')} className="bg-golden-yellow/80 hover:bg-golden-yellow text-warm-brown border-none" size="sm">
          ...
          <div className="mb-8">
            <SimpleRhythmPlayer pattern={[true, false, true, false]} label="Mercato 2 - Practice Rhythm" />
          </div>
        </div>
        ...
        <div className="mb-16">
          ...
          <p className="text-cream text-lg mb-8 text-center">Half Speed</p>
          ...
          <div className="mb-8">
            ...
            <div className="rounded-2xl overflow-hidden shadow-2xl">
              <iframe style={{
              borderRadius: '16px'
            }} src="https://open.spotify.com/embed/track/4FMWYCgSUTyLXCoX3GK8We?utm_source=generator&theme=0" width="100%" height="352" frameBorder="0" allowFullScreen allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy" />
            </div>
          </div>
          ...
          <div className="mb-8">
            <div className="bg-warm-brown/20 backdrop-blur-sm rounded-2xl p-6 border border-cream/20">
              ...
              <div className="flex justify-center mb-6">
                <ToggleGroup type="single" value={rhythmSpeed} onValueChange={value => value && setRhythmSpeed(value)} className="bg-warm-brown/40 rounded-lg p-1">
                  <ToggleGroupItem value="1" className="data-[state=on]:bg-terracotta data-[state=on]:text-cream text-cream/70 hover:text-cream">
                    1
                  </ToggleGroupItem>
                  <ToggleGroupItem value="2" className="data-[state=on]:bg-golden-yellow data-[state=on]:text-warm-brown text-cream/70 hover:text-cream">
                    2
                  </ToggleGroupItem>
                  <ToggleGroupItem value="4" className="data-[state=on]:bg-dusty-rose data-[state=on]:text-cream text-cream/70 hover:text-cream">
                    4
                  </ToggleGroupItem>
                </ToggleGroup>
              </div>
              ...
              {/* Rhythm Player */}
              <SimpleRhythmPlayer pattern={getRhythmPattern(rhythmSpeed)} label={`Practice Rhythm - Speed ${rhythmSpeed}`} speedLevel={getSpeedLevel(rhythmSpeed)} />
          ...
          <div className="flex items-center gap-4 bg-sage-green/20 backdrop-blur-sm rounded-2xl p-6 border border-sage-green/30">
            <Checkbox id="task-1" checked={completedTasks['task-1'] || false} onCheckedChange={() => handleTaskComplete('task-1')} />
            ...
            <div className="space-y-4">
              <div className="bg-warm-brown/20 backdrop-blur-sm rounded-2xl p-6 border border-cream/20">
                <div className="flex items-center justify-between">
                  ...
                  <Button onClick={() => playAudio('2to4', 'https://res.cloudinary.com/dl9xg597r/video/upload/v1749839311/mercato_2_to_4_Me_quede_mirandola_widbtv.mp3')} className="bg-terracotta/80 hover:bg-terracotta text-cream border-none" size="sm">
              ...
              <div className="bg-warm-brown/20 backdrop-blur-sm rounded-2xl p-6 border border-cream/20">
                <div className="flex items-center justify-between">
                  ...
                  <Button onClick={() => playAudio('4to2', 'https://res.cloudinary.com/dl9xg597r/video/upload/v1749839311/mercato4_to_2Me_quede_mirandola_n189ki.mp3')} className="bg-terracotta/80 hover:bg-terracotta text-cream border-none" size="sm">
            ...
            <div className="space-y-4">
              <div className="bg-warm-brown/20 backdrop-blur-sm rounded-2xl p-6 border border-cream/20">
                <div className="flex items-center justify-between">
                  ...
                  <Button onClick={() => playAudio('legato-staccato', 'https://res.cloudinary.com/dl9xg597r/video/upload/v1749839311/legato_to_Stacatto_Invierno_-_Francisco_Canaro-_gcc7qs.mp3')} className="bg-sage-green/80 hover:bg-sage-green text-cream border-none" size="sm">
              ...
              <div className="bg-warm-brown/20 backdrop-blur-sm rounded-2xl p-6 border border-cream/20">
                <div className="flex items-center justify-between">
                  ...
                  <Button onClick={() => playAudio('staccato-legato', 'https://res.cloudinary.com/dl9xg597r/video/upload/v1749839311/Stacatto_to_legato_Invierno_-_Francisco_Canaro-_ho4nwj.mp3')} className="bg-sage-green/80 hover:bg-sage-green text-cream border-none" size="sm">
        ...
        <div className="mb-16">
          ...
          <div className="space-y-6">
            {["Walk alone at speeds 1, 2, and 4, without music, just counting, or use the rhythm lab in the app.", "Walk alone with music.", "When dancing in milonga or practice, listen to the change in rhythm from 2 to 4 and back, and try to use a different speed.", "When dancing in milonga or practice, listen to the change in melody from legato to staccato and back, and try to use a different speed."].map((assignment, index) => <div key={index} className="flex items-start gap-4 bg-golden-yellow/20 backdrop-blur-sm rounded-2xl p-6 border border-golden-yellow/30">
                <Checkbox id={`assignment-${index}`} checked={completedTasks[`assignment-${index}`] || false} onCheckedChange={() => handleTaskComplete(`assignment-${index}`)} />
