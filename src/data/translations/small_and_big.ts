...
export const smallAndBigTranslations = {
  exercises: {
    dancingSmallBig: {
      title: {
        en: "Dancing Small and Big",
        de: "Klein und Groß tanzen"
      },
      introText1: {
      ...
      tipsTitle: {
        ...
        de: "Tipps für größere Schritte"
      },
      tip1: {
        en: "You have to have more control and contact with the floor",
        de: "Du musst mehr Kontrolle und Kontakt zum Boden haben"
      },
      tip2: {
        en: "Push the floor more",
        de: "Drücke den Boden mehr"
      },
      tip3: {
      ...
      tip4: {
        ...
        de: "Dein Follower braucht dreimal mehr Geduld als üblich"
      },
      ...
      musicalConnectionText1: {
        en: "Now let's connect to the music. Listen to melody being rhythmical (Staccato) or being like singing (Legato).",
        de: "Nun lass uns mit der Musik verbinden. Höre, wie die Melodie rhythmisch (Staccato) oder wie Gesang (Legato) ist."
      },
      musicalConnectionText2: {
        en: "Rhythmical melody is a good candidate for dancing smaller.",
        de: "Rhythmische Melodie ist ein guter Kandidat für kleineres Tanzen."
      },
      ...
      practiceTitle: {
        ...
        de: "Übe mit verschiedenen musikalischen Charakteren"
      },
      practiceDescription: {
      ...
      daily: {
        ...
        day5: {
          content: {
            ...
            de: "Mische schnelle und langsame Geschwindigkeit mit kleinen und großen Schritten und erhalte 4 Optionen."
          },
          task: {
